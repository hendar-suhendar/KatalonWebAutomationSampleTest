...
'Verifikasi notifikasi error Input Pengeluaran "Isi kurang dari nilai sebelumnya" dan Disable tombol hitung untuk melanjutkan proses hitung harga'
WebUI.scrollToElement(findTestObject("Object Repository/Page_Hitung Harga/Titile_page"),2)
WebUI.verifyTextPresent("Isi kurang dari nilai sebelumnya", false)
WebUI.verifyElementHasAttribute(findTestObject("Object Repository/Page_Hitung Harga/button_Hitung"), "disabled", 5)
WebUI.takeScreenshot()
